...
举一个例子，在Windows上进行开发，现在需要将某个目录及其子目录中所有配置文件的`xx.xx.12.13`替换为`141.151.1.111`，不知道具体哪个配置文件中含有待替换字符串并且这样的配置文件多而且分散。如果在`Windows`手动查找或者写`bat`脚本都是一件很费劲的事情，而在`Linux`中只需要一行命令：
...
![](https://gitee.com/fengmengzhao/fengmengzhao.github.io/raw/master/img/posts/wsl-ext4-image-file.png)
...
![](https://gitee.com/fengmengzhao/fengmengzhao.github.io/raw/master/img/posts/wsl2-ubuntu-from-microsoft-store.png)
...
![](https://gitee.com/fengmengzhao/fengmengzhao.github.io/raw/master/img/posts/wsl2-nat-network-ping-relation.png)
...
![](https://gitee.com/fengmengzhao/fengmengzhao.github.io/raw/master/img/posts/wsl-add-port-mapping-to-win.png)
...
![](https://gitee.com/fengmengzhao/fengmengzhao.github.io/raw/master/img/posts/wsl2-zsh-init-start-dockerd.png)
...
![](https://gitee.com/fengmengzhao/fengmengzhao.github.io/raw/master/img/posts/wsl2-explorer-exe-from-wsl.png)
...
![](https://gitee.com/fengmengzhao/fengmengzhao.github.io/raw/master/img/posts/wsl2-open-pingexe.png)
...
![](https://gitee.com/fengmengzhao/fengmengzhao.github.io/raw/master/img/posts/wsl2-win-open-wslping.png)
