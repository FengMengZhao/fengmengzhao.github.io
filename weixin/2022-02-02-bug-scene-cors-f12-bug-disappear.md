...
background: 'https://gitee.com/fengmengzhao/fengmengzhao.github.io/raw/master/img/posts/bug-scene-cros-origin.png'
comment: false
...
![](https://gitee.com/fengmengzhao/fengmengzhao.github.io/raw/master/img/posts/cros-application-client-cache-browser-refresh-two-times.png)
...
![](https://gitee.com/fengmengzhao/fengmengzhao.github.io/raw/master/img/posts/cros-application-client-cache-browser-refresh-two-times-server-side-cache-0.png)
...
![](https://gitee.com/fengmengzhao/fengmengzhao.github.io/raw/master/img/posts/bug-scene-cors-same-origin-request.jpg)

跨域请求，如图：

![](https://gitee.com/fengmengzhao/fengmengzhao.github.io/raw/master/img/posts/bug-scene-cors-cross-origin-request.jpg)
...
![](https://gitee.com/fengmengzhao/fengmengzhao.github.io/raw/master/img/posts/same-origin-ajax-post-request.png)
...
![](https://gitee.com/fengmengzhao/fengmengzhao.github.io/raw/master/img/posts/cros-ajax-post-simple-request-console-and-network-message.png)
...
![](https://gitee.com/fengmengzhao/fengmengzhao.github.io/raw/master/img/posts/cros-ajax-post-complex-request-console-error.png)

网络抓包如图：

![](https://gitee.com/fengmengzhao/fengmengzhao.github.io/raw/master/img/posts/cros-ajax-post-complex-request-network-traffic.png)
...
![](https://gitee.com/fengmengzhao/fengmengzhao.github.io/raw/master/img/posts/cros-ajax-post-complex-request-with-options-implementation-but-withou-allow-origin-in-options.png)
...
![](https://gitee.com/fengmengzhao/fengmengzhao.github.io/raw/master/img/posts/cros-ajax-post-complex-request-with-options-implementation-but-real-request-access-allow-none1.png)

控制台还是有`客户端实际请求`报错，不过这个错误就很熟悉了：

![](https://gitee.com/fengmengzhao/fengmengzhao.github.io/raw/master/img/posts/cros-ajax-post-complex-request-with-options-implementation-but-real-request-access-allow-none2.png)
...
![](https://gitee.com/fengmengzhao/fengmengzhao.github.io/raw/master/img/posts/cros-ajax-post-complex-request-all-success.png)

“复杂”请求的`preflight`和`客户端实际请求`都成功了，实现了“复杂”请求的跨域资源共享。

“复杂”请求整个生命历程，概括如图：

![](https://gitee.com/fengmengzhao/fengmengzhao.github.io/raw/master/img/posts/bug-scene-cors-whole-process.jpg)
